...
def index():
    ...
    data = {
        ...
        , rpi_sys_info.os_name
        , rpi_sys_info.cpu_usage_info
        , rpi_sys_info.cpu_processor_count
        , rpi_sys_info.cpu_core_frequency
        , rpi_sys_info.cpu_core_volt
        , rpi_sys_info.cpu_temperature
        , rpi_sys_info.boot_info
        , rpi_sys_info.memory_usage_info
